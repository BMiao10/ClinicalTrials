...
def plotGeographicDistributionbyState(locations_df, average="mean", values="EnrollmentAvg", title="Number of clinical trial locations by state", 
                                      log_value=None, scale_label="Count", return_df=False, figsize=(950,650)):
    """
...
def plotPerPopulationTrial(values, state_code_dict, normalize=10e4, figsize=(950,650),title="Clinical trial locations per 100k population",
